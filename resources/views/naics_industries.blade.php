                    ...
                    <table class="table-auto w-full dataTable ">
                        <thead  class="bg-light-blue">
                            <tr>
                                ...
                                <th class="px-4 py-2">NAICS Code</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-title="NAICS Code" class=" px-4 py-2">{{ $industry->code }}</td>
                                <td data-title="Branch" class=" px-4 py-2">{{ $industry->title }}</td>
                                ...
                                <td class=" px-4 py-2 action  ">
                                    <a href="{{ route('naics_industries.edit', ['id' => $industry->id]) }}" class="btn-bg-primary text-white flex  justify-center font-bold py-2 px-4 ">Edit</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
