    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm p-8">
                <form method="POST" action="{{ route('industries.update', $industry->id) }}">
                    @method('PATCH')
                    @csrf
                    <div class="flex flex-wrap gap-y-4">
                        <div class="sm:w-1/2 sm:pr-2">
                            <label for="wz_code">WZ Code</label>
                            <input id="wz_code" class="block mt-1 w-full" type="text" name="wz_code" value="{{ $industry->wz_code }}" required autofocus />
                        </div>
