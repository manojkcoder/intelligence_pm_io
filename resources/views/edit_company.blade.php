<x-app-layout>
    ...
    <style>
        ...
        .select2-container .select2-selection--single{height:42px;margin-top:.25rem;}
        .select2-container--default .select2-selection--single .select2-selection__rendered{line-height:42px;}
        .select2-container--default .select2-selection--single .select2-selection__arrow{height:42px;top:4px;}
    </style>
    <script>
